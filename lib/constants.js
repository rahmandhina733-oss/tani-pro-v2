...
export const NAV_PETANI = [
  ...
  { label: "Pre-Order",       href: "/petani/pre-order",      ikon: "CalendarClock" },
...
export const NAV_PEMBELI = [
  { label: "Dashboard",       href: "/pembeli",               ikon: "LayoutDashboard" },
  { label: "Katalog",         href: "/pembeli/katalog",       ikon: "ShoppingBag" },
  { label: "Pesanan Saya",    href: "/pembeli/pesanan",       ikon: "ClipboardList" },
  { label: "Checkout",        href: "/pembeli/checkout",      ikon: "ShoppingCart" },
